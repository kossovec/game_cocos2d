...
declare namespace cc {
    ...
    export class LayerRGBA extends cc.Layer
    {

    }

    export class Control extends cc.LayerRGBA
    {
    ...
    {
        constructor(size: cc.Size, background: ccui.Scale9Sprite, background_1?: ccui.Scale9Sprite, background_2?: ccui.Scale9Sprite);
        public setString(str: string): void;
        public getString(): string;
        public setPlaceholderFont(fontName: string, size: number): void;
        public setFont(fontName: string, size: number): void;
        public setDelegate(obj: EditBoxDelegate): void;
        public setInputFlag(flag: number): void;
        public setInputMode(mode: number): void;
        public setReturnType(type: number): void;
