...
// Class Definitions
    ...
    export class Node extends Class {
         ...
         * TODO: Uncomment once GLProgram is defined.
         */
        public setShaderProgram(newShaderProgram:GLProgram):void;
    ...
    export class GLProgram extends Class
    {
        ...
        public initWithString(s1:string, s2:string):boolean;

        public initWithVertexShaderFilename(vShader:string, fShader:string):boolean;

        public addAttribute(s:string, n:number): void;

        public link(): boolean;

        public updateUniforms(): void;

        public getUniformLocationForName(s:string): WebGLUniformLocation;
        
        public use(): void;

        public setUniformLocationWith1f(s:WebGLUniformLocation, n:number): void;

        public setUniformLocationWith2f(s:WebGLUniformLocation, n:number, n2:number): void;
    }
}